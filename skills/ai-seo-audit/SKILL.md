---
name: ai-seo-audit
description: "SEO 审计助手. Use this skill when the user asks for SEO 审计助手. Do not use when the user goal does not match this skill description."
requiredEnvVars:
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `ai-seo-audit` 对应的 AI Skills API/工作流。
