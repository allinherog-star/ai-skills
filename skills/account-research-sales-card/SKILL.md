---
name: account-research-sales-card
...
# account-research-sales-card 销售增长助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `account-research-sales-card` 对应的 AI Skills API/工作流。
