---
name: policy-execution-checklist-generator
...
# policy-execution-checklist-generator 风险审阅助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `policy-execution-checklist-generator` 对应的 AI Skills API/工作流。
