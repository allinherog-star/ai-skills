---
name: sku-trend-opportunity-report
...
# sku-trend-opportunity-report 业务诊断助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `sku-trend-opportunity-report` 对应的 AI Skills API/工作流。
