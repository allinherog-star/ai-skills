---
name: lesson-plan-activity-designer
...
# lesson-plan-activity-designer 视觉质量诊断助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `lesson-plan-activity-designer` 对应的 AI Skills API/工作流。
