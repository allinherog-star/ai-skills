---
name: travel-itinerary-content-planner
...
# travel-itinerary-content-planner 文案诊断助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `travel-itinerary-content-planner` 对应的 AI Skills API/工作流。
