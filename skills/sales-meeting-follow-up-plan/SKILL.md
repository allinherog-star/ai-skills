---
name: sales-meeting-follow-up-plan
description: "销售增长助手. Use this skill when the user asks for 销售增长助手. Do not use when the user goal does not match this skill description."
requiredEnvVars:
...
# sales-meeting-follow-up-plan 销售增长助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `sales-meeting-follow-up-plan` 对应的 AI Skills API/工作流。
