---
name: course-landing-page-conversion-review
...
# course-landing-page-conversion-review 转化实验助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `course-landing-page-conversion-review` 对应的 AI Skills API/工作流。
