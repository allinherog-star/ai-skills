---
name: financial-report-anomaly-question-list
...
# financial-report-anomaly-question-list 财务定价诊断助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `financial-report-anomaly-question-list` 对应的 AI Skills API/工作流。
