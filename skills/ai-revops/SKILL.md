---
name: ai-revops
description: "RevOps 诊断助手. Use this skill when the user asks for RevOps 诊断助手. Do not use when the user goal does not match this skill description."
requiredEnvVars:
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `ai-revops` 对应的 AI Skills API/工作流。
