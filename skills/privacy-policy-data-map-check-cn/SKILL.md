---
name: privacy-policy-data-map-check-cn
...
# privacy-policy-data-map-check-cn 风险审阅助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `privacy-policy-data-map-check-cn` 对应的 AI Skills API/工作流。
