---
name: brand-account-positioning-diagnosis
...
# brand-account-positioning-diagnosis 业务诊断助手
...
当前导出包由 AI Skills 站点目录自动生成，运行时后端仍然指向 `brand-account-positioning-diagnosis` 对应的 AI Skills API/工作流。
